...
import { mockIdeasData } from '@/lib/mock-data';
...
export default function IdeasPage() {
  const { data, loading } = useMockData<MarketIdeasResponse>(
            ...
            <div key={idea.idea_id} className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="bg-gray-50 rounded p-3">
                  ...
                  <span className={`ml-2 font-semibold ${idea.potential_liquidity === 'high' ? 'text-green-600' :
                ...
                <div className="bg-gray-50 rounded p-3">
                  ...
                  <span className={`ml-2 font-semibold ${idea.time_sensitivity === 'high' ? 'text-red-600' :
