...
type Tab = 'daily-note' | 'digest' | 'anomaly';
...
export default function ChainGptToolsPage() {
  const [tab, setTab] = useState<Tab>('daily-note');
  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <h1 className="text-3xl font-bold text-gray-900">ChainGPT Tools</h1>
      <p className="text-gray-600 mt-2">
        Internal preview UI for UC3/UC4/UC6. Requires server env <code className="font-mono">CHAINGPT_API_KEY</code>.
      </p>
