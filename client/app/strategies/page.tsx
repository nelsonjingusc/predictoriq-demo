...
import { mockStrategiesData } from '@/lib/mock-data';
...
export default function StrategiesPage() {
  const { data, loading } = useMockData<StrategyListResponse>(
            ...
            <div key={strategy.strategy_id} className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex flex-col items-end gap-2">
                  <span className={`px-3 py-1 rounded text-sm font-medium ${strategy.risk_level === 'low' ? 'bg-green-100 text-green-700' :
